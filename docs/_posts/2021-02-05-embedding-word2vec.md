...
The diagram below shows the ROC curves for four models that we discussed recently.
...
The ROC curves demonstrate that the easy-to-interpret "bag-of-words with logistic regression" model provides good results while remaining simple.
