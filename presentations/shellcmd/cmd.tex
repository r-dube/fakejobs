...
\begin{frame}{What is file-less malware?}
	...
	\begin{itemize}
		...
		\item Eg., VBscripts, PowerShell scripts, or the use of system commands, such as netsh commands.
...
\begin{frame}{Malicious shell commands are a subset of file-less malware}
	...
	\begin{itemize}
		...
		\item A command line that appears in both malicous and benign analyses is declared malicious if ... \textcolor{red}{needs to be defined.}
	\end{itemize}
\end{frame}
